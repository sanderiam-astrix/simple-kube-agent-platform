...
print_info "Terraform Directory Setup for AWS CloudShell"
echo "=============================================="
echo
print_warning "This script configures Terraform to use /tmp directories"
print_warning "to work within CloudShell space limitations."
echo
...
echo
print_info "To make these settings permanent for this session, run:"
echo "export TF_DATA_DIR=$TF_DATA_DIR"
echo "export TF_PLUGIN_CACHE_DIR=$TF_PLUGIN_CACHE_DIR"
echo
print_info "Or add these lines to your ~/.bashrc or ~/.profile:"
echo "export TF_DATA_DIR=$TF_DATA_DIR"
echo "export TF_PLUGIN_CACHE_DIR=$TF_PLUGIN_CACHE_DIR"
echo
